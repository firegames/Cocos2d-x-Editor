...
-(void)addViewToFirstRootAsTabLayoutView:(NSView<TabLayoutContentInterface>*)view
{
    TabLayoutView *tabView = [[[TabLayoutView alloc] initWithHandler:self view:view] autorelease];
    [self addLayoutView:tabView toNode:self.firstResponsedRoot direction:LayoutRelativeDirectionLeft size:NSZeroSize relativeNode:nil];
}
